...
\paragraph{In 2018, GitHub released their own CI/CD tool, GitHub Actions. Section 4 of this report will analyze the software and document how it implement the principles commonplace in the practices of continuous integration and continuous development.}
...
\begin{lstlisting}[language=Java, basicstyle=\footnotesize, frame=single, caption={Project Structure}]
...
\begin{lstlisting}[language=, basicstyle=\footnotesize, frame=single, caption={GitHub Actions Workflow (YAML)}, showstringspaces=false]
...
The investment in setting up RTS (configuration, caching, team education) is minimal compared to the long-term benefits in developer productivity, infrastructure cost reduction, and faster feedback cycles. We recommend that software engineering teams evaluate RTS for their projects and consider it a best practice for modern CI/CD pipelines.
