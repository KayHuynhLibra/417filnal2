...
\begin{itemize}
    ...
    \item Execution time: 2.844 seconds (Maven test execution)
    \item CI workflow time: 9-10 seconds (including setup and checkout)
...
\begin{itemize}
    ...
    \item Execution time: 2.844 seconds (as observed in GitHub Actions CI)
...
\hline
Demo Project & 10 & 2.84s (10 tests) & 1.0-1.5s (7 tests) & 70\% & 47-65\% \\
\hline
Apache CSV & 300+ & 45s (300+ tests) & 8s (12 tests) & 4\% & 82\% \\
\hline
\end{tabular}
\caption{Comparison of test execution with and without Ekstazi RTS. Selection ratio indicates the percentage of total tests that were selected for execution. Demo project results are from actual CI execution (2.84s for 10 tests).}
\label{tab:results}
\end{table}
